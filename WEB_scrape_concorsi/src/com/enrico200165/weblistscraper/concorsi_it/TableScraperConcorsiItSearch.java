 ...
 *
 */
public class TableScraperConcorsiItSearch extends TableScraperConcorsiBase {

	public TableScraperConcorsiItSearch(SessionManagerAbstr smgrPar, PageConfigABC tcfgPar, EntryProcessorABC ep) {
	...
	private static Logger log = LogManager.getLogger(TableScraperConcorsiItSearch.class.getSimpleName());
}
