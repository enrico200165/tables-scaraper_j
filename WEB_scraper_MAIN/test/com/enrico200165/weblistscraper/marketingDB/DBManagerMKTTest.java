...
import java.util.logging.Level;import org.junit.Before;
...
public class DBManagerMKTTest {
    ...
    private static Logger log = LogManager.getLogManager().getLogger(DBManagerMKTTest.class.getSimpleName());
}