 ...
 *
 */
public class TableScraperConcorsiItGeoTable extends TableScraperConcorsiBase {

	public TableScraperConcorsiItGeoTable(SessionManagerAbstr smgrPar, PageConfigABC tcfgPar, EntryProcessorABC ep) {
	...
	private static Logger log = LogManager.getLogger(TableScraperConcorsiItGeoTable.class.getSimpleName());
}
